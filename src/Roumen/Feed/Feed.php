 ...
 * @version 2.10.1-bugfix
 * @link https://roumen.it/projects/laravel-feed
 * @link https://github.com/frohlfing/laravel-feed/tree/v2.10.1-bugfix
...
class Feed
{
     ...
     * @param \Carbon\Carbon|integer $cache (0 - turns off the cache)
     * @param string $key
    ...
    public function render($format = null, $cache = null, $key = null)
    {
        ...
        $channel = [
            'title'         =>  $this->title, // #FR: nun ohne strip_tags
     ...
     *
     * @param \Carbon\Carbon|int|string $date
     * @param string $format
     * @return string
     */
